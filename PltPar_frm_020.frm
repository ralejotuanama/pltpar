...
Begin VB.Form frm_GirCom_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   8880
            Picture         =   "PltPar_frm_020.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   24
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   675
            Left            =   6810
            Picture         =   "PltPar_frm_020.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   1
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   675
            Left            =   7500
            Picture         =   "PltPar_frm_020.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Borrar 
            Height          =   675
            Left            =   8190
            Picture         =   "PltPar_frm_020.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   3
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Cancel 
            Height          =   675
            Left            =   8850
            Picture         =   "PltPar_frm_020.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   8130
            Picture         =   "PltPar_frm_020.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   7
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.ComboBox cmb_CodCiu 
            ...
            Width           =   7995
         End
         Begin EditLib.fpDoubleSingle ipp_MarUti 
            Height          =   315
            Left            =   1530
            TabIndex        =   20
            Top             =   1050
      ...
      Begin Threed.SSPanel SSPanel10 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   90
            Picture         =   "PltPar_frm_020.frx":14B8
            Top             =   90
            Width           =   480
         End
      End
   End
End
Attribute VB_Name = "frm_GirCom_01"
...
Private Sub cmd_Borrar_Click()
   ...
   g_str_Parame = "USP_MNT_GIRCOM_BORRAR (" & "'" & moddat_g_str_Codigo & "', "
...
Private Sub cmd_Editar_Click()
   ...
   g_str_Parame = g_str_Parame & "SELECT * FROM MNT_GIRCOM WHERE "
   g_str_Parame = g_str_Parame & "GIRCOM_CODIGO = '" & moddat_g_str_Codigo & "' "
   ...
   txt_Codigo.Text = Trim(g_rst_Princi!GIRCOM_CODIGO)
   txt_Descri.Text = Trim(g_rst_Princi!GIRCOM_DESCRI)
   
   Call gs_BuscarCombo_Item(cmb_CodCiu, g_rst_Princi!GIRCOM_CODCIU)
   
   ipp_MarUti.Value = g_rst_Princi!GIRCOM_MARUTI
...
Private Sub cmd_Grabar_Click()
   If Len(Trim(txt_Codigo.Text)) = 0 Then
      MsgBox "EL Código del Giro Comercial está vacío.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(txt_Codigo)
      Exit Sub
   End If
   ...
   If moddat_g_int_FlgGrb = 1 Then
      ...
      g_str_Parame = ""
      g_str_Parame = g_str_Parame & "SELECT * FROM MNT_GIRCOM WHERE "
      g_str_Parame = g_str_Parame & "GIRCOM_CODIGO = '" & txt_Codigo.Text & "'"
      ...
      If Not (g_rst_Genera.BOF And g_rst_Genera.EOF) Then
         ...
         MsgBox "El Código del Giro Comercial ya ha sido registrado..", vbExclamation, modgen_g_str_NomPlt
         Exit Sub
      End If
   ...
   Do While moddat_g_int_FlgGOK = False
      ...
      g_str_Parame = g_str_Parame & CStr(ipp_MarUti.Value) & ", "
      g_str_Parame = g_str_Parame & "'" & modgen_g_str_CodUsu & "', "
      g_str_Parame = g_str_Parame & "'" & modgen_g_str_NombPC & "', "
      g_str_Parame = g_str_Parame & "'" & UCase(App.EXEName) & "', "
      g_str_Parame = g_str_Parame & "'" & modgen_g_str_CodSuc & "', "
...
Private Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & "ORDER BY GIRCOM_CODIGO ASC "
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = Trim(g_rst_Princi!GIRCOM_CODIGO)
      
      grd_Listad.Col = 1
      grd_Listad.Text = Trim(g_rst_Princi!GIRCOM_DESCRI)
      
      grd_Listad.Col = 2
      grd_Listad.Text = Format(g_rst_Princi!GIRCOM_MARUTI, "###,###,##0.00")
...
Private Sub ipp_MarUti_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
