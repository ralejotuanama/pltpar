...
Begin VB.Form frm_Produc_06 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Parámetros por Actividad Económica"
   ClientHeight    =   10110
   ClientLeft      =   3615
   ClientTop       =   390
   ClientWidth     =   8220
   Icon            =   "PltPar_frm_016.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   90
            Picture         =   "PltPar_frm_016.frx":000C
            Top             =   90
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin Threed.SSPanel pnl_SubPrd 
            ...
            Alignment       =   1
         End
         Begin Threed.SSPanel pnl_ActEco 
            Height          =   315
            Left            =   1260
            TabIndex        =   10
            Top             =   420
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   675
            Left            =   6690
            Picture         =   "PltPar_frm_016.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   7380
            Picture         =   "PltPar_frm_016.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   20
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Borrar 
            Height          =   675
            Left            =   6000
            Picture         =   "PltPar_frm_016.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   19
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   675
            Left            =   4590
            Picture         =   "PltPar_frm_016.frx":0EA4
            Style           =   1  'Graphical
            TabIndex        =   18
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   675
            Left            =   5280
            Picture         =   "PltPar_frm_016.frx":11AE
            Style           =   1  'Graphical
            TabIndex        =   17
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_Cancel 
            Height          =   675
            Left            =   7380
            Picture         =   "PltPar_frm_016.frx":14B8
            Style           =   1  'Graphical
            TabIndex        =   23
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   6690
            Picture         =   "PltPar_frm_016.frx":17C2
            Style           =   1  'Graphical
            TabIndex        =   22
   ...
   End
End
Attribute VB_Name = "frm_Produc_06"
...
Private Sub cmd_Editar_Click()
   ...
   g_str_Parame = g_str_Parame & "PARACT_CODITE = '" & moddat_g_str_CodIte & "'"
   ...
   txt_Codigo.Text = Trim(g_rst_Genera!PARACT_CODITE)
   txt_Nombre.Text = Trim(g_rst_Genera!PARACT_DESCRI)
   
   Call gs_BuscarCombo_Item(cmb_TipPar, g_rst_Genera!PARACT_TIPPAR)
   
   If cmb_TipPar.ItemData(cmb_TipPar.ListIndex) = 3 Then
      Call gs_BuscarCombo_Item(cmb_FlgObl, g_rst_Genera!PARACT_FLGOBL)
      cmb_FlgObl.Enabled = True
   Else
      Call gs_BuscarCombo_Item(cmb_TipVal, g_rst_Genera!PARACT_TIPVAL)
      
      ipp_Cantid.Text = Format(g_rst_Genera!PARACT_CANTID, "###,###,###,##0.000000")
      ipp_ValMin.Text = Format(g_rst_Genera!PARACT_VALMIN, "###,###,###,##0.000000")
      ipp_ValMax.Text = Format(g_rst_Genera!PARACT_VALMAX, "###,###,###,##0.000000")
...
Private Sub cmd_Grabar_Click()
   ...
   If moddat_g_int_FlgGrb = 1 Then
      ...
      g_str_Parame = g_str_Parame & "PARACT_CODACT = " & moddat_g_str_CodMod & " AND "
      g_str_Parame = g_str_Parame & "PARACT_CODGRP = '" & moddat_g_str_CodGrp & "' AND "
      g_str_Parame = g_str_Parame & "PARACT_CODITE = '" & txt_Codigo.Text & "' "
...
Private Sub cmd_Imprim_Click()
   ...
   crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "PAR_PARACT_02.RPT"
   crp_Imprim.Action = 1
End Sub
...
Private Sub Form_Load()
   ...
   pnl_ActEco.Caption = moddat_g_str_CodMod & " - " & moddat_g_str_DesMod
...
Private Sub fs_Buscar()
   ...
   Do While Not g_rst_Genera.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = g_rst_Genera!PARACT_CODITE
      
      grd_Listad.Col = 1
      grd_Listad.Text = g_rst_Genera!PARACT_DESCRI
