...
Begin VB.Form frm_Produc_09 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel9 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   7350
            Picture         =   "PltPar_frm_024.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Salir"
            Top             =   60
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   675
            Left            =   6660
            Picture         =   "PltPar_frm_024.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   675
            Left            =   5940
            Picture         =   "PltPar_frm_024.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   2
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.CommandButton cmd_Borrar 
            Height          =   675
            Left            =   7380
            Picture         =   "PltPar_frm_024.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   675
            Left            =   6000
            Picture         =   "PltPar_frm_024.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   675
            Left            =   6690
            Picture         =   "PltPar_frm_024.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   7
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Cancel 
            Height          =   675
            Left            =   7350
            Picture         =   "PltPar_frm_024.frx":1380
            Style           =   1  'Graphical
            TabIndex        =   15
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   6660
            Picture         =   "PltPar_frm_024.frx":168A
            Style           =   1  'Graphical
            TabIndex        =   14
      ...
      Begin Threed.SSPanel SSPanel12 
         ...
         Begin Threed.SSPanel SSPanel13 
            ...
            _ExtentY        =   847
            _StockProps     =   15
            Caption         =   "Valores para Seguro de Desgravamen"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   90
            Picture         =   "PltPar_frm_024.frx":1ACC
            Top             =   90
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_Produc_09"
...
Private Sub cmb_EmpSeg_Click()
   ...
   If cmb_EmpSeg.ListIndex > -1 Then
      ...
      Call moddat_gs_Carga_TipSeg(cmb_TipSeg, l_arr_EmpSeg(cmb_EmpSeg.ListIndex + 1).Genera_Codigo)
...
Private Sub cmd_Borrar_Click()
   ...
   g_str_Parame = "USP_BORRAR_MNT_SEGPRE (" & "'" & moddat_g_str_CodPrd & "', "
...
Private Sub cmd_Buscar_Click()
   ...
   If cmb_TipSeg.ListIndex = -1 Then
      MsgBox "Debe seleccionar el Tipo de Seguros.", vbExclamation, modgen_g_str_NomPlt
      Call gs_SetFocus(cmb_TipSeg)
      Exit Sub
   End If
...
Private Sub cmd_Editar_Click()
   ...
   g_str_Parame = g_str_Parame & "SELECT * FROM MNT_SEGPRE WHERE "
   g_str_Parame = g_str_Parame & "SEGPRE_CODPRD = '" & moddat_g_str_CodPrd & "' AND "
   g_str_Parame = g_str_Parame & "SEGPRE_CODSUB = '" & moddat_g_str_CodSub & "' AND "
   g_str_Parame = g_str_Parame & "SEGPRE_CODIGO = '" & moddat_g_str_Codigo & "' AND "
   g_str_Parame = g_str_Parame & "SEGPRE_TIPSEG = '" & moddat_g_str_CodGrp & "' AND "
   g_str_Parame = g_str_Parame & "SEGPRE_TIPMON = " & CStr(CInt(r_str_Codigo)) & " AND "
   g_str_Parame = g_str_Parame & "SEGPRE_IMPMIN = " & r_str_ImpMin & " "
   ...
   Call gs_BuscarCombo_Item(cmb_TipMon, g_rst_Princi!SEGPRE_TIPMON)
   ipp_ImpMin.Value = g_rst_Princi!SEGPRE_IMPMIN
   ipp_ImpMax.Value = g_rst_Princi!SEGPRE_IMPMAX
   
   Call gs_BuscarCombo_Item(cmb_TipApl, g_rst_Princi!SEGPRE_VTATIP)
   ipp_FacImp.Value = g_rst_Princi!SEGPRE_VTAFOI
...
Private Sub cmd_Grabar_Click()
   ...
   If moddat_g_int_FlgGrb = 1 Then
      ...
      g_str_Parame = g_str_Parame & "SEGPRE_CODIGO = '" & moddat_g_str_Codigo & "' AND "
      g_str_Parame = g_str_Parame & "SEGPRE_TIPSEG = '" & moddat_g_str_CodGrp & "' AND "
      g_str_Parame = g_str_Parame & "SEGPRE_TIPMON = " & CStr(cmb_TipMon.ItemData(cmb_TipMon.ListIndex)) & " AND "
      g_str_Parame = g_str_Parame & "SEGPRE_IMPMIN = " & CStr(ipp_ImpMin.Value) & " "
...
Private Sub fs_Buscar()
   ...
   moddat_g_str_CodGrp = CStr(cmb_TipSeg.ItemData(cmb_TipSeg.ListIndex))
   ...
   g_str_Parame = g_str_Parame & "SEGPRE_CODSUB = '" & moddat_g_str_CodSub & "' AND "
   g_str_Parame = g_str_Parame & "SEGPRE_CODIGO = '" & moddat_g_str_Codigo & "' AND "
   g_str_Parame = g_str_Parame & "SEGPRE_TIPSEG = '" & moddat_g_str_CodGrp & "' "
   g_str_Parame = g_str_Parame & "ORDER BY SEGPRE_TIPMON ASC"
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SEGPRE_TIPMON))
      
      grd_Listad.Col = 1
      grd_Listad.Text = Format(g_rst_Princi!SEGPRE_IMPMIN, "###,###,##0.00")
      
      grd_Listad.Col = 2
      grd_Listad.Text = Format(g_rst_Princi!SEGPRE_IMPMAX, "###,###,##0.00")
      
      grd_Listad.Col = 3
      grd_Listad.Text = moddat_gf_Consulta_ParDes("227", CStr(g_rst_Princi!SEGPRE_VTATIP))
      
      grd_Listad.Col = 4
      grd_Listad.Text = Format(g_rst_Princi!SEGPRE_VTAFOI, "#,##0.000000000")
      
      grd_Listad.Col = 5
      grd_Listad.Text = CStr(g_rst_Princi!SEGPRE_TIPMON)
